...
1. Отримати доступ до Google Search Console.
2. Отримати доступ до Bing Webmaster.
3. Заповнити `.env` згідно `.env.example`.
4. Провести першу перевірку Coverage/Scan і записати результати у цей протокол.
